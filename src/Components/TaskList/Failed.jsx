...
function Failed({data}) {
  return (
   <div className='bg--300 h-full w-[350px] shrink-0 rounded-2xl border-2 border-amber-50 p-5 '>
            ...
            <div className='flex itmes-center justify-between mt-4'>
                <button className='bg-red-600 w-full py-1 px-1 rounded cursor-pointer'>Failed</button>
            </div>
        </div>  
  )
}
